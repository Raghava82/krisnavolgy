...
class Calendar_Panel(wx.Panel):
    ...
    def __init__(self, parent, id):
        ...
        self.cal = wx.lib.calendar.Calendar(self, id, pos=(0, 35), size=screenSize)
        ...
        # create year spin
        self.texty = wx.TextCtrl(self, -1, str(start_year), pos=(5, 5), size=(50, -1))
        h = self.texty.GetSize().height
        self.spiny = wx.SpinButton(self, -1, pos=(57, 5), size=(h*2, h))
        self.spiny.SetRange(2020, 2030)
        self.spiny.SetValue(start_year)
        self.Bind(wx.EVT_SPIN, self.OnSpiny, self.spiny)
        # create month spin
        self.textm = wx.TextCtrl(self, -1, str(start_month), pos=(120, 5), size=(50, -1))
        h = self.textm.GetSize().height
        self.spinm = wx.SpinButton(self, -1, pos=(170, 5), size=(h*2, h))
...
frame = wx.Frame(None, -1, "Simple calendar", size = wx.DisplaySize())
